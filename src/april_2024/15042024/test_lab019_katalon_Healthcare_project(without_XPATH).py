...
def test_katalon_appointment_positive():
    ...
    # * you can this by using link_text  ----> either this
    make_appointment = driver.find_element(By.LINK_TEXT, "Make Appointment")
    make_appointment.click()
    time.sleep(2)

    # * you can this by using tag_name   ---> or, either this
    ...
    assert change_url == "https://katalon-demo-cura.herokuapp.com/appointment.php#summary"
    time.sleep(2)
    ...
    Go_to_Homepage = driver.find_element(By.LINK_TEXT, "Go to Homepage")
    Go_to_Homepage.click()
    time.sleep(2)

    # assert "CURA Healthcare Service" in driver.title           # * you can use this assert,or
    assert driver.title == "CURA Healthcare Service"             # * you can use this assert
    time.sleep(2)

    email = driver.find_element(By.LINK_TEXT, "info@katalon.com")
    email.click()
    time.sleep(2)
